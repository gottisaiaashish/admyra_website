      ...
      >
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl">
          <div className="text-center mb-5">
            ...
            <p className="text-[11px] text-white/40">Continue your journey with Admyra</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-text-muted ml-1">Email or Username</label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                ...
                <Link to="/forgot-password" name="forgot-password-link" className="text-xs text-primary-start hover:underline">Forgot password?</Link>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-text-muted group-focus-within:text-primary-start transition-colors">
                  <Lock size={18} />
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-12 pr-12 text-text-main focus:outline-none focus:ring-2 focus:ring-primary-start/50 focus:border-primary-start transition-all"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl bg-white/5 border border-white/10 text-white/60 hover:bg-white/10 transition-all text-xs font-medium mt-2"
            >
          ...
          <p className="mt-4 text-center text-xs text-text-muted">
            ...
            <Link to="/signup" name="signup-link" className="text-primary-start font-bold hover:underline">Sign Up</Link>
          </p>
        </div>
      </motion.div>
    </div>
